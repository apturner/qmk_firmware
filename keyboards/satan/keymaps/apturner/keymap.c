...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = KEYMAP_ANSI(
        ...
        ____,  ____, ____,  UNDO,    REDO,    ____, KC_PGUP, KC_HOME,   KC_UP,  KC_END,   ____,   ____,   ____,   ____, \
        ____,   CUT, COPY, PASTE,    ____,    ____, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS, KC_GRV,           ____, \
        ____,        ____,  ____, SOFT_UN, SOFT_RE,    ____,    ____,    ____,    ____,   ____,   ____,           ____, \
