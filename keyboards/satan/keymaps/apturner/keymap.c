...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------------------------------------------------------------------|
     * |      |    |WLDN|MSUP|WLUP|    |ACK9|ACL1| UP |ACL2|    |    |    |      |
     * |-------------------------------------------------------------------------|
    ...
    [_FN1] = KEYMAP_ANSI(
        ...
        ____,    ____, KC_WH_D, KC_MS_U, KC_WH_U,    ____, KC_ACL0, KC_ACL1,   KC_UP, KC_ACL2,    ____,   ____,   ____,   ____, \
    ...
    [_FN2] = KEYMAP_ANSI(
        ...
        ____, ____,  CUT, COPY,   PASTE,    ____, ____, KC_KP_4, KC_KP_5, KC_KP_6,    ____, ____,        ____, \
